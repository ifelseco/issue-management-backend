...
public class EmailConstants {
    ...
    public static final String CONFIRM_USER_EMAIL_URL=AppConstants.WEB_URL+"/api/user/confirm-email?uuid=";
    public static final String CONFIRM_DEVELOPER_EMAIL_URL=AppConstants.WEB_URL+"/api/team/invitation-confirm-email?uuid=";
